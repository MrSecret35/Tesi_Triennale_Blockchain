...
%utilizzare òla blockchain pubblica per inserire l'hash di ogni nuovo blocco così da certificare l'intera catena
...
Questo sviluppo può essere attuato dopo un'analisi sugli spazi occupati. Esaminando la memoria occupata da un solo log insieme alla quantità di log salvati in un determinato lasso di tempo   
